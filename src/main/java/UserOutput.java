 ...
 */
public class UserOutput extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new UserOutput(), args);
        System.exit(res);
    }
    ...
    private static boolean frequencyCountjob(Configuration conf) throws Exception {
        ...
        Job job = Job.getInstance(conf, "user Series");
